...
namespace WallpaperController {
    public partial class Form1 : Form {
        ...
        private async Task ParseConfig() {
            selectConfigFileToolStripMenuItem.Text = Settings.Default.ConfigPath;
            try {
        ...
        private async void selectConfigFileToolStripMenuItem_Click(object sender, EventArgs e) {
